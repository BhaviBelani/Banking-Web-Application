package com.NewProject.BankingSolutions.config;

import com.NewProject.BankingSolutions.interceptors.AppInterceptor;
...
@Configuration
@ComponentScan(basePackages = {"com.NewProject.BankingSolutions"})
